...
VWAPforecast <- vwap %>%
  group_by(Date) %>%
  summarize(PredVWAPSarimax = sum(PredTradeAmt, na.rm = TRUE) / sum(Forecast, na.rm = TRUE),
...
legend("bottomright", legend = c("SARIMA", "SARIMAX", "Naive Strategies"), col = c("firebrick1", "firebrick4", "blue"), lty = 1, cex = 0.5)
